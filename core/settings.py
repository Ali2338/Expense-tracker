...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://expense-tracker-ten-beige-98.vercel.app",  
]
...
CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^http://localhost:\d+$",
    r"^http://127\.0\.0\.1:\d+$",  
    r"^https:\/\/expense-tracker-.*\.vercel\.app$", 
]
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'mohammadali98999899@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '') 
DEFAULT_FROM_EMAIL = f"LedgerFlow Security <{EMAIL_HOST_USER}>"
